...
export default function AdminConfiguratorPage() {
  ...
  const [activeSurface, setActiveSurface] = useState('listing'); // which storefront page is being configured + previewed
  ...
  return (
    <div className="admin-page-container">
      ...
      <main className="admin-main-container flex flex-col gap-8">
        ...
        <div className="surface-tabbar grid grid-cols-2 sm:grid-cols-4 gap-2 bg-surface-container rounded-xl p-1.5 border border-outline-variant/35">
          {SURFACES.map((s) => (
            <button
              key={s.key}
              type="button"
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-6">
          ...
          {/* Form actions — apply to the whole theme regardless of which surface tab is active */}
