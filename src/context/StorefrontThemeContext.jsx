...
function hexToRgb(hex) {
  if (!hex || typeof hex !== 'string') return '172, 36, 113';
...
const applyThemeToDom = (themeData) => {
  ...
  const rgbVal = hexToRgb(prim);
  root.style.setProperty('--color-primary-rgb', rgbVal);
...
function getInitialTheme() {
  try {
    ...
    console.error('Failed reading initial theme from localStorage:', e);
  }
